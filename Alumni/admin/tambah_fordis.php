        ...
        <form method="POST" action="proses_fordis.php">
          <div class="form-group">
            <div class="form-label-group">
              ...
              <option value="<?php echo $d['ID_KATEGORIDISK'];?>"> <?php echo $d['KATEGORI'];?> </option>
              <?php } ?>
              </select>
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" name="TITLE" id="firstName" class="form-control" placeholder="First name" required="required" autofocus="autofocus">
                  <label for="firstName">Judul Diskusi</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" name="CONTENT" id="lastName" class="form-control" placeholder="Last name" required="required">
