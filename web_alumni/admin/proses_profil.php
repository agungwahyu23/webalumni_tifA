...
//proses edit
    ...
    if($query){
        echo "<script>alert('Data berhasil diedit .');window.location=('media.php?halaman=data_alumni')</script>";
    }else{
        echo "<script>alert('Data gagal diedit .');window.location=('media.php?halaman=edit_alumni')</script>";
    }
    ...
    if($query){
        echo "<script>alert('Data berhasil dihapus .');window.location=('media.php?halaman=data_alumni')</script>";
    }else{
        echo "<script>alert('Data gagal dihapus .');window.location=('media.php?halaman=data_alumni')</script>";
    }
}
